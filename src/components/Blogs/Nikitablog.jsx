        ...
        <div className="dark:bg-gray-900 text-white flex align-item-center justify-content-center m-auto">
            ...
            <div className="m-auto p-1 bg-[#27293F] min-h-screen mx-5 mt-32 mb-10">
                ...
                <div class="px-10 max-w-[1300px] leading-7 mt-5 md:px-20 sm:px-10">
                    ...
                    <h1 className="mt7 text-4xl font-bold max-x-sm:text-2xl">Early Stage</h1>
                    ...
                    <h1 className="mt7 text-4xl font-bold max-x-sm:text-2xl">Learning Web Design</h1>
                    ...
                    <h1 className="mt7 text-4xl font-bold max-x-sm:text-2xl">Freelancing</h1>
                    ...
                    <h1 className="mt7 text-4xl font-bold max-x-sm:text-2xl">Personal Projects</h1>
                    ...
                    <h1 className="mt7 text-4xl font-bold max-x-sm:text-2xl">Current Stage and My Advice</h1>

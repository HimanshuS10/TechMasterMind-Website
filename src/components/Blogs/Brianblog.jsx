        ...
        <div className="dark:bg-gray-900 text-[#DCDCDD] flex align-item-center justify-content-center m-auto">
            ...
            <div className="m-auto p-1 bg-[#27293F] min-h-screen mx-5 mt-32 mb-10">
                ...
                <div className="p-5 z-0">
                    <div
                        ...
                        <div className="w-full md:w-[300px] h-[300px]">
                            <img src={Pfp} className="w-full h-full object-cover" alt="Image of Brian Ruiz" />
                        </div>
                        <div className="text-white flex flex-col justify-center space-y-3 p-5 w-full md:w-6/12">
                            <h1 className="text-2xl font-bold">Brian Ruiz</h1>
                            <h2 className="text-xl">Full Stack Engineer at <a href="https://www.hines.com/" target="_blank"
                                className="text-blue-400 hover:underline">Hines</a></h2>
                ...
                <div className="px-10 max-w-[1300px] leading-7 mt-5 md:px-52 sm:px-10 max-phone:px-5">
                    <h1 className="mt-7 text-4xl font-bold max-mid:text-3xl max-phone:text-2xl max-phone:my-0">Here's How Brian Became a <span
                        className="shadow-[inset_0_-0.25em_rgba(37,99,235,0.8)]">Full Stack Engineer</span> Without a
                        Degree.</h1>


                    <h1 className="mt-7 text-4xl font-bold max-mid:text-3xl max-phone:text-2xl max-phone:my-0">Early Age</h1>
                    <p className="my-7 text-lg md:text-[22px] max-sm:text-base">From a young age, Brian always had a keen
                        interest in
                    ...
                    <p className="my-7 text-lg md:text-[22px] max-sm:text-base">This natural curiosity eventually led him toward
                        the field of
                        computer science, setting the foundation for his future career as a full-stack engineer.</p>

                    <h1 className="mt-7 text-4xl font-bold max-mid:text-3xl max-phone:text-2xl max-phone:my-0">Education</h1>
                    <p className="my-7 text-lg md:text-[22px] max-sm:text-base">Like many in his field, Brian did not follow the
                        traditional
                        educational path. He chose not to attend boot camps and doesn't hold a college degree.</p>
                    <p className="my-7 text-lg md:text-[22px] max-sm:text-base">Instead, he spent three years at university,
                        where he immersed
                    ...
                    <p className="my-7 text-lg md:text-[22px] max-sm:text-base">His perspective on formal education is nuanced.
                        While he didn't
                    ...
                    <p className="my-7 text-lg md:text-[22px] max-sm:text-base">One of Brian's key strategies for success has
                        been his
                    ...
                    <p className="my-7 text-lg md:text-[22px] max-sm:text-base">His work with Python packages like Pandas and
                        Numpy, in
                    ...
                    <p className="my-7 text-lg md:text-[22px] max-sm:text-base">Like many developers, Brian faced his share of
                        challenges.
                        Imposter syndrome was a significant hurdle, especially early in his career.</p>
                    <p className="my-7 text-lg md:text-[22px] max-sm:text-base">The fast-paced nature of the tech industry and
                        the vast amount
                    ...
                    <p className="my-7 text-lg md:text-[22px] max-sm:text-base">Over time, he learned to trust in his abilities
                        and recognize
                        the value he brought to his roles.</p>

                    <h1 className="mt7 text-4xl font-bold max-x-sm:text-2xl">Advice for Newcomers</h1>
                    ...
                    <h1 className="mt-7 text-4xl font-bold max-mid:text-3xl max-phone:text-2xl max-phone:my-0">Online Resources</h1>
                    <ul className="my-7 text-lg md:text-[22px] max-sm:text-base">
                    ...
                    <h1 className="mt-7 text-4xl font-bold max-mid:text-3xl max-phone:text-2xl max-phone:my-0">Conclusion</h1>
                    <p className="my-7 text-lg md:text-[22px] max-sm:text-base">Brian's journey to becoming a full-stack
                        engineer at Hines is a
                        testament to the power of curiosity, persistence, and continuous learning.</p>
                    <p className="my-7 text-lg md:text-[22px] max-sm:text-base">His story inspires aspiring software engineers
                        and demonstrates

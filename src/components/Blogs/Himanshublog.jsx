            ...
            <div className="m-auto p-1 bg-[#27293F] min-h-screen mx-5 mt-32 mb-10">
                    ...
                    <div
                        ...
                        <div className="text-white flex flex-col justify-center space-y-3 p-5 w-full md:w-6/12">
                            ...
                            <p className="text-base text-gray-300">
                                Hi there! My name is Himanshu Seervi, and I am the founder of Tech MasterMind. On this page,
                                I'll be sharing my journey in building Tech MasterMind. Read the blog below to learn more
                                about me and Tech MasterMind.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="px-10 max-w-[1300px] leading-7 mt-5 md:px-52 sm:px-10 max-phone:px-5">
                    ...
                    <p className="my-7 text-lg md:text-[22px] max-sm:text-base">It's a website where I will interview a bunch of
                        <strong> techpreneurs and software engineers </strong>
                        to share their journey on how they become successful and share some advice for someone who wants to
                        do the same.
                    </p>

                    <p className="my-7 text-lg md:text-[22px] max-sm:text-base">I want to interview techpreneurs, basically
                        founders who
                        started a tech/software company, to see how they got started.</p>
                    <p className="my-7 text-lg md:text-[22px] max-sm:text-base">I also want to interview a bunch of <u>9-5
                        developers</u> on
                    ...
                    <p className="my-7 text-lg md:text-[22px] max-sm:text-base">This is why I want to interview developers so
                        that current CS
                        students, like me, can have a <u>blueprint to follow</u>, giving themselves a higher chance than
                    ...
                    <p className="my-7 text-lg md:text-[22px] max-sm:text-base">So as I mentioned before that I am going into
                        ...
                        <u className="underline decoration-blue-500"><a className="editor-rtfLink decoration-dashed"
                            href="https://www.youtube.com/watch?v=T_wEmB5MapE" rel="noopener noreferrer"
                            target="_blank">"How I Built A $1M Business From This
                            Starbucks"</a></u> and he says “I can turn these questions into a product”, which sparked
                        the idea for something similar to Starter Story.
                    </p>

                    <p className="my-7 text-lg md:text-[22px] max-sm:text-base">This led to the creation of <u>Tech
                        MasterMind</u>, inspired by
                        Starter Story but with my own unique twist. I then had the thought of creating something to guide
                        current CS students, like me, in the right direction and also inspire entrepreneurs to start their
                        own tech companies.</p>
                    <p className="my-7 text-lg md:text-[22px] max-sm:text-base">Now here is the best part I can showcase this
                        project on my

    ...
    return (
        <div className="container relative flex flex-col items-center bg-black p-4 rounded-lg shadow-2xl shadow-blue-500 mt-20 z-[-10]">
            ...
            <div className="w-full aspect-w-16 aspect-h-9">
                <picture className="grid w-[400px] aspect-[4/3] grid-rows-picture">
                    {/* Border */}
                    <div className="absolute bg-red-500 clip-border"></div>

                    {/* Image */}
                    <img
                        src={Image}
                        alt="Mouse"
                        className="grid-area-[2/1/4/2] w-full h-full object-cover clip-img"
                    />
